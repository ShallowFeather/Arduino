...
void loop()
{
    if (ts.touched() && !beentouched)
    {
        ...
        else if (lastchar >= '0' && lastchar <= '9' && !toLong) {
                if (Tf_check == true) {
                    if (lastchar != '1' && lastchar != '2' && lastchar != '3') {
                        ...
                        tft.drawRoundRect(0, 0, 320, 48, 8, ILI9341_ORANGE);
                        tft.print("=");
                        if (lastchar == '1') tft.print(std::sin(key1.toInt()));
                        else if (lastchar == '2') tft.print(std::cos(key1.toInt()));
                        else if (lastchar == '3') tft.print(std::tan(key1.toInt()));
                        key1 = "";
                        key2 = "";
                        answer = 0;
        ...
        || lastchar == 'X' || lastchar == '^' || lastchar == 'T') && key2 == "" && key1 != "" && !toLong) {
